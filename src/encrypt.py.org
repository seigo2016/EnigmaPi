...
def main(rotor: list, plug: list) -> str:
    # シード,順序入力
    ...
    scrumblers: List[List] = make_rotor(rotor[0], rotor[1], rotor[2], 0)
    ...
    while True:
        ...
        # 回転の反映
        now_scrumbler_1: List[int] = scrumbler_1[roter_1_index:] + \
            scrumbler_1[:roter_1_index]
        now_scrumbler_2: List[int] = scrumbler_2[roter_2_index:] + \
            scrumbler_2[:roter_2_index]
        now_scrumbler_3: List[int] = scrumbler_3[roter_3_index:] + \
            scrumbler_3[:roter_3_index]
        # ローター
